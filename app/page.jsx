    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-white overflow-hidden">
      ...
      <div className="flex w-full min-h-screen flex-col md:flex-row">
        <Link href="/kitchens-baths" onMouseEnter={() => setHovered("kb")} onMouseLeave={() => setHovered(null)} className="group relative flex flex-1 flex-col items-center justify-start overflow-hidden cursor-pointer" style={{ minHeight: "50vh" }}>
          ...
          <div className="relative z-10 flex flex-col items-center gap-5 px-8 text-center" style={{ marginTop: "38vh" }}>
            <div className="text-base uppercase tracking-[0.3em] text-white/50">Interior Remodels</div>
            <h2 className="text-3xl font-semibold tracking-tight text-white leading-tight whitespace-nowrap">Kitchen &amp; Bath</h2>
            <p className="max-w-xs text-sm leading-7 text-white/65">Premium kitchen and bathroom transformations built around clean design and quality materials.</p>
            <div className="mt-2 flex items-center gap-2 rounded-full border border-white/30 bg-white/10 px-5 py-2.5 text-sm font-medium text-white backdrop-blur-sm transition-all duration-300 group-hover:bg-white group-hover:text-neutral-900 group-hover:border-white">
              Explore
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4 transition-transform duration-300 group-hover:translate-x-1"><path fillRule="evenodd" d="M3 10a.75.75 0 01.75-.75h10.638L10.23 5.29a.75.75 0 111.04-1.08l5.5 5.25a.75.75 0 010 1.08l-5.5 5.25a.75.75 0 11-1.04-1.08l4.158-3.96H3.75A.75.75 0 013 10z" clipRule="evenodd" /></svg>
            </div>
          </div>
        </Link>
        <Link href="/outdoor" onMouseEnter={() => setHovered("outdoor")} onMouseLeave={() => setHovered(null)} className="group relative flex flex-1 flex-col items-center justify-start overflow-hidden cursor-pointer" style={{ minHeight: "50vh" }}>
          ...
          <div className="relative z-10 flex flex-col items-center gap-5 px-8 text-center" style={{ marginTop: "38vh" }}>
            ...
            <h2 className="text-3xl font-semibold tracking-tight text-white leading-tight whitespace-nowrap">Hardscape, Landscape &amp; Pools</h2>
            <p className="max-w-xs text-sm leading-7 text-white/65">Custom pools, patios, pavers, full outdoor transformations across the Los Angeles area.</p>
            <div className="mt-2 flex items-center gap-2 rounded-full border border-white/30 bg-white/10 px-5 py-2.5 text-sm font-medium text-white backdrop-blur-sm transition-all duration-300 group-hover:bg-white group-hover:text-neutral-900 group-hover:border-white">
              Explore
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4 transition-transform duration-300 group-hover:translate-x-1"><path fillRule="evenodd" d="M3 10a.75.75 0 01.75-.75h10.638L10.23 5.29a.75.75 0 111.04-1.08l5.5 5.25a.75.75 0 010 1.08l-5.5 5.25a.75.75 0 11-1.04-1.08l4.158-3.96H3.75A.75.75 0 013 10z" clipRule="evenodd" /></svg>
            </div>
