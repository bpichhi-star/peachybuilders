  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-white overflow-hidden">
        ...
        <div className="absolute inset-x-0 top-0 z-20 flex flex-col items-center pt-10 pb-8 pointer-events-none select-none">
          ...
          {/* Tagline */}
          <p className="mt-3 text-xs uppercase tracking-[0.35em] font-bold text-neutral-400">
            Kitchen &amp; Bath &bull; Interior Remodels
          </p>
        </div>
        ...
        <div className="flex w-full min-h-screen flex-col md:flex-row">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center gap-5 px-8 text-center">
              <div className="text-xs uppercase tracking-[0.3em] font-bold text-white/50">Interior Remodels</div>
              <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-white leading-tight">
                Kitchen &amp; Bath
              </h2>
              <p className="max-w-xs text-sm font-bold leading-7 text-white/65">
                Premium kitchen and bathroom transformations built around clean design and quality materials.
              </p>
              <div className="mt-2 flex items-center gap-2 rounded-full border border-white/30 bg-white/10 px-5 py-2.5 text-sm font-bold text-white transition-all duration-300 hover:bg-white/20">
                Explore
        ...
        {/* — Footer line ——————————————————————————————————— */}
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-20 text-xs font-bold tracking-[0.25em] uppercase text-neutral-400 whitespace-nowrap">
