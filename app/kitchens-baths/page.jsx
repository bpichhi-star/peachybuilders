      ...
      <main>
        ...
        <section id="gallery" className="bg-stone-100 py-20">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <Link href="/projects/kitchens-baths" className="group overflow-hidden rounded-[2rem] border border-stone-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl block">
              <div className="relative h-80 overflow-hidden bg-cover bg-center" style={{ backgroundImage: "url('/images/projects/kitchens-baths/kb-10.jpg')" }}>
              ...
              <div className="p-7">
                <h3 className="text-xl font-semibold transition duration-200 group-hover:text-neutral-500">Kitchens &amp; Baths</h3>
                <div className="mt-1 text-sm text-stone-500">Kitchen & Bathroom Remodels</div>
                <p className="mt-3 text-sm leading-7 text-neutral-600">Premium kitchen and bathroom transformations built around clean design, quality materials, and layouts that work for how you actually live.</p>
              </div>
            </Link>
          </div>
        </section>
