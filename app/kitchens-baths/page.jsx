      ...
      <header className="sticky top-0 z-50 border-b border-stone-200/80 bg-stone-50/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
          ...
          <nav className="hidden items-center gap-8 text-sm text-neutral-700 md:flex">
            ...
            <a href="#contact" className="rounded-full border border-neutral-900 px-4 py-2 font-medium transition hover:bg-neutral-900 hover:text-stone-50">
              Get Estimate
            </a>
          </nav>
          <button
        ...
        {menuOpen && (
          <div className="border-t border-stone-200 bg-stone-50 px-6 py-4 md:hidden">
            <nav className="flex flex-col gap-4 text-sm text-neutral-700">
              ...
              <a href="#contact" onClick={() => setMenuOpen(false)}>Get Estimate</a>
            </nav>
          </div>
        )}
      </header>
      ...
      <main>
        ...
        <section className="relative overflow-hidden">
          <div
            ...
            style={{ backgroundImage: "url('/images/projects/kitchens-baths/kb-9.jpg')" }}
          ></div>
          ...
          <div className="relative mx-auto max-w-7xl px-6 py-28 lg:px-8 lg:py-40">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <a href="#gallery" className="rounded-full bg-white px-7 py-3 text-sm font-semibold text-neutral-900 shadow-sm transition hover:-translate-y-px">
                View Our Work
              </a>
            ...
            <div className="mt-12 flex flex-wrap gap-3">
              {["Licensed & Insured", "25+ Years Experience", "Free Estimates", "Design-Driven"].map((badge) => (
                <div key={badge} className="rounded-full border border-white/20 bg-white/10 px-4 py-2 text-sm text-white/80 backdrop-blur-sm">
                  {badge}
                </div>
              ))}
            </div>
        ...
        <section id="services" className="bg-white py-20">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {[
                "Kitchen Remodels", "Bathroom Remodels", "Custom Cabinetry", "Countertops & Surfaces",
                "Tile & Backsplash", "Fixture Upgrades", "Spa Bathrooms", "Open Concept Layouts",
              ].map((tag) => (
                <div key={tag} className="rounded-2xl border border-stone-200 bg-stone-50 px-4 py-3 text-sm text-neutral-700">
                  {tag}
                </div>
              ))}
            </div>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              ...
              >
                ...
                >
                  <div className="absolute inset-0 bg-neutral-900/0 transition-all duration-300 group-hover:bg-neutral-900/25"></div>
                ...
                <div className="p-7">
                  <h3 className="text-xl font-semibold transition duration-200 group-hover:text-neutral-500">Kitchens</h3>
                  <div className="mt-1 text-sm text-stone-500">Custom Kitchen Remodels</div>
              ...
              >
                <div
                  className="relative h-64 overflow-hidden bg-cover bg-center"
                  style={{ backgroundImage: "url('/images/projects/kitchens-baths/kb-8.jpg')" }}
                >
                  <div className="absolute inset-0 bg-neutral-900/0 transition-all duration-300 group-hover:bg-neutral-900/25"></div>
                  <div className="absolute bottom-4 right-4 flex items-center gap-1.5 rounded-full bg-white/95 px-3.5 py-2 text-xs font-semibold text-neutral-900 opacity-0 shadow-md backdrop-blur-sm transition-all duration-300 group-hover:opacity-100">
                    View Photos
                ...
                <div className="p-7">
                  <h3 className="text-xl font-semibold transition duration-200 group-hover:text-neutral-500">Bathrooms</h3>
                  <div className="mt-1 text-sm text-stone-500">Spa-Inspired Bathroom Renovations</div>
                  <p className="mt-3 text-sm leading-7 text-neutral-600">
                    Spa-inspired bathroom renovations featuring custom tile work, premium fixtures, vanities, and thoughtful layouts that work beautifully.
                  </p>
                </div>
              </a>
        ...
        <section id="process" className="bg-white py-20">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
              {[
                { num: "01", title: "Consultation", desc: "We walk through your space, understand your vision, and discuss design direction, materials, and budget." },
                { num: "02", title: "Design & Planning", desc: "We finalize the layout, select materials, and create a plan so every decision is made with intention." },
                { num: "03", title: "Build & Execution", desc: "Our team executes with precision — quality craftsmanship and clear communication throughout." },
                { num: "04", title: "Final Walkthrough", desc: "We review every detail together to ensure the finished space exceeds your expectations." },
              ].map((step) => (
                <div key={step.num} className="rounded-[2rem] border border-stone-200 bg-stone-50 p-7">
                  <div className="text-sm font-medium tracking-[0.22em] text-stone-400">{step.num}</div>
                  <h3 className="mt-4 text-xl font-semibold">{step.title}</h3>
                  <p className="mt-3 text-sm leading-7 text-neutral-600">{step.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="bg-stone-100 py-12">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="flex flex-wrap items-center justify-between gap-6 rounded-[2rem] border border-stone-200 bg-white p-8">
              {[
                { label: "License", value: "License #1058911" },
                { label: "Coverage", value: "Fully Insured" },
                { label: "Experience", value: "25+ Years" },
                { label: "Estimates", value: "Always Free" },
              ].map((item) => (
                <div key={item.label}>
                  <div className="text-sm uppercase tracking-[0.24em] text-stone-400">{item.label}</div>
            ...
            <div className="grid gap-8 p-8 lg:grid-cols-2 lg:p-14">
              <div>
                ...
                <p className="mt-4 text-lg leading-8 text-stone-300">
                  Whether it&apos;s a kitchen remodel, bathroom renovation, or a full interior transformation — reach out and we&apos;ll walk you through next steps.
                </p>
              ...
              <div className="rounded-[2rem] bg-white p-7 text-neutral-900">
                ...
                <div className="mt-6 space-y-4">
                  ...
                  <textarea className="h-28 w-full rounded-2xl border border-stone-200 px-4 py-3 text-sm outline-none transition focus:border-neutral-800" placeholder="Tell us about your project" name="message"></textarea>
                  <button type="button" className="w-full rounded-full bg-neutral-900 py-3 text-sm font-medium text-stone-50 transition hover:opacity-90">
                    Submit Request
                  </button>
                </div>
              </div>
